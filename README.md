...
1. Чем реже встречается слово, тем больше оно тяготеет либо к резко негативным, либо к очень позитивным отзывам.
2. Группы Слов: <br>
 1. Слова: "a" , "both", "own", "real", "bit", "many", "cast" имеют позитивную эмоциональную окраску 52-59% упоминаний в позитивных отзывах. <br>
 2. Слова: "his", "her", "she" имеют позитивную эмоциональную окраску - 52-59% упоминаний в позитивных отзывах <br>
 3. Слова: "gives", 'DVD", "each", "our", "often", "become" имеют позитивную эмоциональную окраску - 57-65% упоминаний в позитивных отзывах. <br> <br>
 4. Слова: "they" , "because", "there" имеют негативную окраску - 42-44% упоминаний в позитивных отзывах. (все остальные - негативные) <br>
 5. Слова: "i'm", "thing", "movie", "director", "look", "do" , "and" имеют негативную эмоциональную окраску - 38-45% упоминаний в позитивных отзывах. <br>
 6. Слова: "money", "minutes", "reason", "guy", "camera, "script" имеют резко негативную эмоциональную окраску - 40-29% упоминаний в позитивных отзывах. <br>
